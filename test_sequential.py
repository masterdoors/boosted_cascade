...
model = CascadeSequentialClassifier(C=100.0, n_layers=10, verbose=2, n_estimators = 1, max_depth=2,max_features=0.5)#, n_iter_no_change = 1, validation_fraction = 0.1)
