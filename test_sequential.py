...
from boosted_forest import CascadeSequentialClassifier
...
model = CascadeSequentialClassifier(C=1.0, n_layers=2, verbose=2, n_estimators = 4, max_depth=3,max_features='sqrt')#, n_iter_no_change = 1, validation_fraction = 0.1)
