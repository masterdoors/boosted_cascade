...
model = CascadeSequentialClassifier(C=1000., n_layers=15, verbose=2, n_estimators = 4, max_depth=1,max_features='sqrt')#, n_iter_no_change = 1, validation_fraction = 0.1)
