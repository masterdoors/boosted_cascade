...
model = CascadeSequentialClassifier(C=0.001, n_layers=10, verbose=2, n_estimators = 4, max_depth=2,max_features='sqrt')#, n_iter_no_change = 1, validation_fraction = 0.1)
